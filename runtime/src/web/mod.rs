...
pub(crate) fn game_session_create_listener(configuration: Value) -> Value {
    web_server_create_listener(configuration)
}

pub(crate) fn game_session_poll_event(listener_handle: Value, timeout_ms: Value) -> Value {
    web_server_poll_event(listener_handle, timeout_ms)
}

pub(crate) fn game_session_accept_connection(listener_handle: Value) -> Value {
    web_server_accept_connection(listener_handle)
}

pub(crate) fn game_session_read_connection_bytes(
    listener_handle: Value,
    connection_handle: Value,
    max_bytes: Value,
) -> Value {
    web_server_read_connection_bytes(listener_handle, connection_handle, max_bytes)
}

pub(crate) fn game_session_read_http_request_frame(
    listener_handle: Value,
    connection_handle: Value,
) -> Value {
    web_server_read_http_request_frame(listener_handle, connection_handle)
}

pub(crate) fn game_session_write_connection_bytes(
    listener_handle: Value,
    connection_handle: Value,
    payload: Value,
) -> Value {
    web_server_write_connection_bytes(listener_handle, connection_handle, payload)
}

pub(crate) fn game_session_write_http_response_frame(
    listener_handle: Value,
    connection_handle: Value,
    response_frame: Value,
) -> Value {
    web_server_write_http_response_frame(listener_handle, connection_handle, response_frame)
}

pub(crate) fn game_session_write_http_response_vectored(
    listener_handle: Value,
    connection_handle: Value,
    head_bytes: Value,
    body_bytes: Value,
    ...
    web_server_write_http_response_vectored(
        listener_handle,
        connection_handle,
        head_bytes,
        body_bytes,
...
pub(crate) fn game_session_send_file(
    listener_handle: Value,
    connection_handle: Value,
    file_path: Value,
    offset: Value,
...
pub(crate) fn game_session_configure_listener_socket(
    listener_handle: Value,
    reuse_port_enabled: Value,
) -> Value {
    web_server_configure_listener_socket(listener_handle, reuse_port_enabled)
}

pub(crate) fn game_session_close_connection(
    listener_handle: Value,
    connection_handle: Value,
) -> Value {
    web_server_close_connection(listener_handle, connection_handle)
}

pub(crate) fn game_session_close_listener(listener_handle: Value) -> Value {
    web_server_close_listener(listener_handle)
}

pub(crate) fn game_session_read_message(listener_handle: Value, connection_handle: Value) -> Value {
    web_server_read_http_request_frame(listener_handle, connection_handle)
}

pub(crate) fn game_session_write_message(
    listener_handle: Value,
    connection_handle: Value,
    message: Value,
) -> Value {
    web_server_write_http_response_frame(listener_handle, connection_handle, message)
}
