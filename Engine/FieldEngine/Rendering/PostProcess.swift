...
package final class PostProcess {
  package let lightingPipeline: MTLComputePipelineState
  package let lightStates: [MTLBuffer]
  package let hdr: MTLTexture
  package let multisample: MTLTexture
  package let bloomA: MTLTexture
  package let bloomB: MTLTexture
  package let extract: MTLComputePipelineState
  package let blur: MTLComputePipelineState
  package let composite: MTLRenderPipelineState
