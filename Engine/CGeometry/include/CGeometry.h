...
size_t sgSimplifyLocal(uint32_t *destination,const uint32_t *indices,size_t indexCount,const void *vertices,size_t vertexCount,const unsigned char *locks,float error,float *resultError,size_t vertexStride);
