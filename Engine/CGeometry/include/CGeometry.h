...
extern "C" {
#endif
size_t sgOptimize(void *vertices, size_t vertexCount, uint32_t *indices, size_t indexCount);
size_t sgSimplify(uint32_t *destination,const uint32_t *indices,size_t indexCount,const void *vertices,size_t vertexCount,float ratio,float error,float *resultError);
