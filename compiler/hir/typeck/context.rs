...
impl ClassIndex {
    fn new(module: &Module) -> Self {
        ...
        for (_idx, class) in module.classes.iter() {
            ...
            let type_param_bounds: Vec<Vec<SmolStr>> = class.type_params.iter().map(|tp| tp.bounds.clone()).collect();
...
fn builtin_functions() -> Vec<(SmolStr, FunctionSig)> {
    ...
    vec![
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("listener_handle"), Type::Integer),
                    (SmolStr::new("timeout_ms"), Type::Integer),
                ],
                ret: Type::Result(
        ...
        (
            ...
            FunctionSig {
                params: vec![(SmolStr::new("listener_handle"), Type::Integer)],
                ret: Type::Result(Box::new(Type::Integer), Box::new(err.clone())),
                kind: FunctionKind::Function,
                type_params: Vec::new(),
                type_param_bounds: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("listener_handle"), Type::Integer),
                    (SmolStr::new("connection_handle"), Type::Integer),
                    (SmolStr::new("max_bytes"), Type::Integer),
                ],
                ret: Type::Result(
                    Box::new(Type::Named(SmolStr::new("Bytes"), Vec::new())),
                    Box::new(err.clone()),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    ...
                    (SmolStr::new("connection_handle"), Type::Integer),
                    (
                        SmolStr::new("response_head_bytes"),
                        Type::Named(SmolStr::new("Bytes"), Vec::new()),
                    ),
                    (
                        SmolStr::new("response_body_bytes"),
                        Type::Named(SmolStr::new("Bytes"), Vec::new()),
                    ),
                    (SmolStr::new("should_close_connection"), Type::Boolean),
                ],
                ret: Type::Result(Box::new(Type::Integer), Box::new(err.clone())),
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("listener_handle"), Type::Integer),
                    (SmolStr::new("connection_handle"), Type::Integer),
                    (SmolStr::new("file_path"), Type::String),
                    (SmolStr::new("offset"), Type::Integer),
                    (SmolStr::new("length"), Type::Integer),
                    (SmolStr::new("content_type"), Type::String),
                    (SmolStr::new("should_close_connection"), Type::Boolean),
                ],
                ret: Type::Result(Box::new(Type::Integer), Box::new(err.clone())),
                kind: FunctionKind::Function,
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("listener_handle"), Type::Integer),
                    (SmolStr::new("reuse_port_enabled"), Type::Boolean),
                ],
        ...
        (
            SmolStr::new("__wr_entity_spawn"),
            FunctionSig {
                params: vec![(SmolStr::new("archetype_id"), Type::Integer)],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
                type_param_bounds: Vec::new(),
        ...
        (
            SmolStr::new("__wr_entity_despawn"),
            FunctionSig {
                params: vec![(SmolStr::new("entity_id"), Type::Integer)],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
                type_param_bounds: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("entity_id"), Type::Integer),
                    (SmolStr::new("x"), Type::Integer),
                    (SmolStr::new("y"), Type::Integer),
                    (SmolStr::new("z"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    ...
                    (SmolStr::new("y"), Type::Integer),
                    (SmolStr::new("z"), Type::Integer),
                    (SmolStr::new("radius"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("sound_id"), Type::Integer),
                    (SmolStr::new("volume"), Type::Integer),
                    (SmolStr::new("pitch"), Type::Integer),
                    (SmolStr::new("pan"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            SmolStr::new("__wr_audio_play_loop"),
            FunctionSig {
                params: vec![
                    (SmolStr::new("sound_id"), Type::Integer),
                    (SmolStr::new("volume"), Type::Integer),
                    (SmolStr::new("fade_ms"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            SmolStr::new("__wr_audio_stop_loop"),
            FunctionSig {
                params: vec![
                    (SmolStr::new("handle"), Type::Integer),
                    (SmolStr::new("fade_ms"), Type::Integer),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("entity_id"), Type::Integer),
                    (SmolStr::new("collider_type"), Type::Integer),
                    (SmolStr::new("mass"), Type::Integer),
                    (SmolStr::new("hx"), Type::Integer),
                    (SmolStr::new("hy"), Type::Integer),
                    (SmolStr::new("hz"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("entity_id"), Type::Integer),
                    (SmolStr::new("vx"), Type::Integer),
                    (SmolStr::new("vy"), Type::Integer),
                    (SmolStr::new("vz"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            SmolStr::new("__wr_physics_step"),
            FunctionSig {
                params: vec![(SmolStr::new("dt_ms"), Type::Integer)],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
                type_param_bounds: Vec::new(),
        ...
        (
            SmolStr::new("__wr_physics_raycast"),
            FunctionSig {
                params: vec![
                    (SmolStr::new("ox"), Type::Integer),
                    (SmolStr::new("oy"), Type::Integer),
                    (SmolStr::new("oz"), Type::Integer),
                    (SmolStr::new("dx"), Type::Integer),
                    (SmolStr::new("dy"), Type::Integer),
                    (SmolStr::new("dz"), Type::Integer),
                    (SmolStr::new("max_dist"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
        ...
        (
            ...
            FunctionSig {
                params: vec![
                    (SmolStr::new("parent_id"), Type::Integer),
                    (SmolStr::new("child_id"), Type::Integer),
                    (SmolStr::new("threshold"), Type::Integer),
                ],
                ret: Type::Integer,
                kind: FunctionKind::Function,
                type_params: Vec::new(),
