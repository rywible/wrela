...
fn builtin_bindings() -> Vec<(SmolStr, BindingKind)> {
    vec![
        ...
        (SmolStr::new("__wr_fs_read_dir"), BindingKind::Function),
        (SmolStr::new("__wr_fs_metadata"), BindingKind::Function),
        (SmolStr::new("__wr_fs_mkdir_all"), BindingKind::Function),
        (SmolStr::new("__wr_fs_remove_file"), BindingKind::Function),
        (SmolStr::new("__wr_fs_remove_dir_all"), BindingKind::Function),
        (SmolStr::new("__wr_fs_rename"), BindingKind::Function),
        (SmolStr::new("__wr_fs_set_executable"), BindingKind::Function),
        ...
        (SmolStr::new("__wr_process_argv"), BindingKind::Function),
        (SmolStr::new("__wr_process_cwd"), BindingKind::Function),
        (SmolStr::new("__wr_process_run"), BindingKind::Function),
        (SmolStr::new("__wr_process_exit"), BindingKind::Function),
        (
