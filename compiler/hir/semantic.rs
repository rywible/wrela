...
fn builtin_bindings() -> Vec<(SmolStr, BindingKind)> {
    vec![
        ...
        (SmolStr::new("__wr_db_open"), BindingKind::Function),
        (SmolStr::new("__wr_db_close"), BindingKind::Function),
        (SmolStr::new("__wr_db_submit_batch"), BindingKind::Function),
        (SmolStr::new("__wr_db_read_point"), BindingKind::Function),
        (SmolStr::new("__wr_db_read_range"), BindingKind::Function),
        (SmolStr::new("__wr_db_txn_begin"), BindingKind::Function),
        (SmolStr::new("__wr_db_txn_prepare"), BindingKind::Function),
        (SmolStr::new("__wr_db_txn_commit"), BindingKind::Function),
        (SmolStr::new("__wr_db_txn_abort"), BindingKind::Function),
        (
        ...
        (SmolStr::new("__wr_db_restore"), BindingKind::Function),
        (
