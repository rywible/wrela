...
pub fn parse_descriptor(kind: ParseDiagKind) -> DiagDescriptor {
    match kind {
        ...
        ParseDiagKind::ExpectedIndentedBlock => DiagDescriptor {
            diag_id: "parse.expected_indented_block",
            code: "lang::parse::expected_indented_block",
            stage: DiagStage::Parse,
            severity_default: DiagSeverity::Error,
            help_template: "Indent the block under this ':' using four spaces.",
        },
