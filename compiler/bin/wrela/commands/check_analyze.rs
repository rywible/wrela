...
fn semantic_hole_payload_and_fixes(
    ...
    match err {
        ...
        hir::semantic::SemanticError::GpuFunctionReturnTypeMustBeString {
            function,
            found,
            expansion_node_id,
            ..
            ...
            Some(serde_json::json!({
                "kind": "gpu_function_return_type",
                "gpu_function": function.to_string(),
                "expected_type": "String",
                "found_type": found.as_ref().map(ToString::to_string),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::GpuFunctionCaptureForbidden {
            function,
            capture_name,
            expansion_node_id,
            ..
            ...
            Some(serde_json::json!({
                "kind": "gpu_function_capture_forbidden",
                "gpu_function": function.to_string(),
        ...
        hir::semantic::SemanticError::RenderContractMissingResources {
            contract,
            expansion_node_id,
            ..
        } => (
            Some(serde_json::json!({
                "kind": "render_v5_missing_resources",
                "contract": contract.to_string(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractUnknownResources {
            contract,
            resources,
            available_assets,
            expansion_node_id,
            ...
            Some(serde_json::json!({
                "kind": "render_v5_unknown_resources",
                "contract": contract.to_string(),
                "resources": resources.to_string(),
                "available_assets": available_assets.iter().map(ToString::to_string).collect::<Vec<_>>(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractMissingTemporal {
            contract,
            expansion_node_id,
            ..
        } => (
            Some(serde_json::json!({
                "kind": "render_v5_missing_temporal",
                "contract": contract.to_string(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractMissingQualityTier {
            contract,
            expansion_node_id,
            ..
        } => (
            Some(serde_json::json!({
                "kind": "render_v5_missing_quality_tier",
                "contract": contract.to_string(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractMissingBudgetTags {
            contract,
            expansion_node_id,
            ..
        } => (
            Some(serde_json::json!({
                "kind": "render_v5_missing_budget_tags",
                "contract": contract.to_string(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractEmptyBudgetTags {
            contract,
            expansion_node_id,
            ..
        } => (
            Some(serde_json::json!({
                "kind": "render_v5_empty_budget_tags",
                "contract": contract.to_string(),
                "expansion_node_id": expansion_node_id,
            })),
            Vec::new(),
        ),
        hir::semantic::SemanticError::RenderContractLegacyClause {
            contract,
            clause,
            expansion_node_id,
            ..
