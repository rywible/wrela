...
fn literal_to_value(literal: &Literal, ty: &PirType) -> Result<PirValue, PirLowerError> {
    match (literal, ty) {
        ...
        (Literal::Integer(value), _) => Ok(PirValue::I32(*value as i32)),
...
fn intrinsic_from_name(name: &str) -> Option<PirIntrinsic> {
    match name {
        ...
        "translate" => Some(PirIntrinsic::Translate),
        "rotate" => Some(PirIntrinsic::Rotate),
        "uniform_scale" => Some(PirIntrinsic::UniformScale),
        "affine_transform" => Some(PirIntrinsic::AffineTransform),
        "warp" => Some(PirIntrinsic::Warp),
        "repeat_linear" => Some(PirIntrinsic::RepeatLinear),
        "repeat_grid" => Some(PirIntrinsic::RepeatGrid),
        "radial_repeat" => Some(PirIntrinsic::RadialRepeat),
        ...
        "field_repeat_linear_point" => Some(PirIntrinsic::RepeatLinear),
        "field_repeat_grid_point" => Some(PirIntrinsic::RepeatGrid),
        "field_radial_repeat_point" => Some(PirIntrinsic::RadialRepeat),
        "field_mirror_array_point" => Some(PirIntrinsic::MirrorArray),
        "field_instance_array_point" => Some(PirIntrinsic::InstanceArray),
        "field_sweep_coords" => Some(PirIntrinsic::FieldSweepCoords),
        "field_bend_point" => Some(PirIntrinsic::Bend),
        "field_twist_point" => Some(PirIntrinsic::Twist),
        "field_taper_point" => Some(PirIntrinsic::Taper),
        "field_displace_point" => Some(PirIntrinsic::Displace),
        "rounded_box" => Some(PirIntrinsic::RoundedBox),
        "circle2" => Some(PirIntrinsic::Circle2),
        "rect2" => Some(PirIntrinsic::Rect2),
        "rounded_rect2" => Some(PirIntrinsic::RoundedRect2),
        "capsule2" => Some(PirIntrinsic::Capsule2),
        "segment2" => Some(PirIntrinsic::Segment2),
        "polygon2" => Some(PirIntrinsic::Polygon2),
        "polyline2" => Some(PirIntrinsic::Polyline2),
        "ellipsoid" => Some(PirIntrinsic::Ellipsoid),
        "cone" => Some(PirIntrinsic::Cone),
        "capped_cone" => Some(PirIntrinsic::CappedCone),
        "box_frame" => Some(PirIntrinsic::BoxFrame),
        "slab" => Some(PirIntrinsic::Slab),
        "triangle_prism" => Some(PirIntrinsic::TrianglePrism),
        "hex_prism" => Some(PirIntrinsic::HexPrism),
        ...
        "smooth_union" => Some(PirIntrinsic::SmoothUnion),
        "smooth_intersection" => Some(PirIntrinsic::SmoothIntersection),
        "smooth_subtract" => Some(PirIntrinsic::SmoothSubtract),
        "field_smooth_union" => Some(PirIntrinsic::SmoothUnion),
        "field_smooth_intersection" => Some(PirIntrinsic::SmoothIntersection),
        "field_smooth_subtract" => Some(PirIntrinsic::SmoothSubtract),
        ...
        "bend" => Some(PirIntrinsic::Bend),
        "twist" => Some(PirIntrinsic::Twist),
        "taper" => Some(PirIntrinsic::Taper),
        "displace" => Some(PirIntrinsic::Displace),
...
fn intrinsic_param_names(intrinsic: PirIntrinsic) -> Vec<SmolStr> {
    match intrinsic {
        ...
        PirIntrinsic::Translate => vec![SmolStr::new("translate"), SmolStr::new("point")],
        PirIntrinsic::Rotate => vec![SmolStr::new("rotate"), SmolStr::new("point")],
        PirIntrinsic::UniformScale => vec![SmolStr::new("scale"), SmolStr::new("point")],
        PirIntrinsic::AffineTransform => vec![SmolStr::new("transform"), SmolStr::new("point")],
        PirIntrinsic::Warp => vec![SmolStr::new("warp"), SmolStr::new("point")],
        PirIntrinsic::RepeatLinear => vec![SmolStr::new("repeat"), SmolStr::new("point")],
        PirIntrinsic::RepeatGrid => vec![SmolStr::new("repeat"), SmolStr::new("point")],
        ...
        PirIntrinsic::Displace => vec![SmolStr::new("displace"), SmolStr::new("point")],
        ...
        PirIntrinsic::FieldSweepCoords => vec![SmolStr::new("path"), SmolStr::new("point")],
        PirIntrinsic::RoundedBox => vec![
            SmolStr::new("p"),
            SmolStr::new("half"),
            SmolStr::new("radius"),
        ],
        PirIntrinsic::Circle2 => vec![SmolStr::new("p"), SmolStr::new("radius")],
        PirIntrinsic::Rect2 => vec![SmolStr::new("p"), SmolStr::new("half")],
        PirIntrinsic::RoundedRect2 => vec![
            SmolStr::new("p"),
            SmolStr::new("half"),
            SmolStr::new("radius"),
        ],
        PirIntrinsic::Capsule2 => vec![
            SmolStr::new("p"),
            SmolStr::new("a"),
            SmolStr::new("b"),
            SmolStr::new("radius"),
        ],
        PirIntrinsic::Segment2 => vec![SmolStr::new("p"), SmolStr::new("a"), SmolStr::new("b")],
        PirIntrinsic::Polygon2 | PirIntrinsic::Polyline2 => {
            vec![SmolStr::new("p"), SmolStr::new("vertices")]
        }
        PirIntrinsic::Ellipsoid => vec![SmolStr::new("p"), SmolStr::new("radii")],
        PirIntrinsic::Cone => vec![
            SmolStr::new("p"),
            SmolStr::new("radius"),
            SmolStr::new("half_height"),
        ],
        PirIntrinsic::CappedCone => vec![
            SmolStr::new("p"),
            SmolStr::new("radius_bottom"),
            SmolStr::new("radius_top"),
            SmolStr::new("half_height"),
        ],
        PirIntrinsic::BoxFrame => vec![
            SmolStr::new("p"),
            SmolStr::new("half"),
            SmolStr::new("thickness"),
        ],
        PirIntrinsic::Slab => vec![SmolStr::new("p"), SmolStr::new("thickness")],
        PirIntrinsic::TrianglePrism => vec![
            SmolStr::new("p"),
            SmolStr::new("half"),
            SmolStr::new("half_height"),
        ],
        PirIntrinsic::HexPrism => vec![
            SmolStr::new("p"),
            SmolStr::new("half"),
            SmolStr::new("half_height"),
        ],
        ...
        PirIntrinsic::SmoothUnion
        | PirIntrinsic::SmoothIntersection
        | PirIntrinsic::SmoothSubtract => vec![
            SmolStr::new("left"),
            SmolStr::new("right"),
            SmolStr::new("k"),
        ],
        ...
        PirIntrinsic::Clamp => vec![
            SmolStr::new("value"),
            SmolStr::new("min"),
            SmolStr::new("max"),
        ],
        PirIntrinsic::Mix => vec![
            SmolStr::new("value"),
            SmolStr::new("other"),
            SmolStr::new("t"),
        ],
