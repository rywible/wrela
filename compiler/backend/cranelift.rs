                        ...
                        CallTarget::Function(name) => {
                            if let Some(id) = func_ids.get(name).copied() {
                                ...
                                match name.as_str() {
                                    ...
                                    "__wr_game_session_create_listener" => Some(
                                        runtime_fn_game_session_create_listener(module, runtime)?,
                                    ),
                                    "__wr_game_session_poll_event" => {
                                        Some(runtime_fn_game_session_poll_event(module, runtime)?)
                                    }
                                    "__wr_game_session_accept_connection" => Some(
                                        runtime_fn_game_session_accept_connection(module, runtime)?,
                                    ),
                                    "__wr_game_session_read_connection_bytes" => {
                                        Some(runtime_fn_game_session_read_connection_bytes(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_read_http_request_frame" => {
                                        Some(runtime_fn_game_session_read_http_request_frame(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_read_message" => {
                                        Some(runtime_fn_game_session_read_message(module, runtime)?)
                                    }
                                    "__wr_game_session_write_connection_bytes" => {
                                        Some(runtime_fn_game_session_write_connection_bytes(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_write_http_response_frame" => {
                                        Some(runtime_fn_game_session_write_http_response_frame(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_write_http_response_vectored" => {
                                        Some(runtime_fn_game_session_write_http_response_vectored(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_write_message" => Some(
                                        runtime_fn_game_session_write_message(module, runtime)?,
                                    ),
                                    "__wr_game_session_send_file" => {
                                        Some(runtime_fn_game_session_send_file(module, runtime)?)
                                    }
                                    "__wr_game_session_configure_listener_socket" => {
                                        Some(runtime_fn_game_session_configure_listener_socket(
                                            module, runtime,
                                        )?)
                                    }
                                    "__wr_game_session_close_connection" => Some(
                                        runtime_fn_game_session_close_connection(module, runtime)?,
                                    ),
                                    "__wr_game_session_close_listener" => Some(
                                        runtime_fn_game_session_close_listener(module, runtime)?,
                                    ),
                                    ...
                                    "__wr_entity_spawn" => {
                                        Some(runtime_fn_entity_spawn(module, runtime)?)
                                    }
                                    "__wr_entity_despawn" => {
                                        Some(runtime_fn_entity_despawn(module, runtime)?)
                                    }
                                    "__wr_entity_set_position" => {
                                        Some(runtime_fn_entity_set_position(module, runtime)?)
                                    }
                                    "__wr_entity_get_position_x" => {
                                        Some(runtime_fn_entity_get_position_x(module, runtime)?)
                                    }
                                    "__wr_entity_get_position_y" => {
                                        Some(runtime_fn_entity_get_position_y(module, runtime)?)
                                    }
                                    "__wr_entity_get_position_z" => {
                                        Some(runtime_fn_entity_get_position_z(module, runtime)?)
                                    }
                                    "__wr_entity_set_component" => {
                                        Some(runtime_fn_entity_set_component(module, runtime)?)
                                    }
                                    "__wr_entity_get_component" => {
                                        Some(runtime_fn_entity_get_component(module, runtime)?)
                                    }
                                    "__wr_entity_query_archetype" => {
                                        Some(runtime_fn_entity_query_archetype(module, runtime)?)
                                    }
                                    "__wr_entity_query_radius" => {
                                        Some(runtime_fn_entity_query_radius(module, runtime)?)
                                    }
                                    "__wr_entity_count" => {
                                        Some(runtime_fn_entity_count(module, runtime)?)
                                    }
                                    "__wr_audio_play_oneshot" => {
                                        Some(runtime_fn_audio_play_oneshot(module, runtime)?)
                                    }
                                    "__wr_audio_play_loop" => {
                                        Some(runtime_fn_audio_play_loop(module, runtime)?)
                                    }
                                    "__wr_audio_stop_loop" => {
                                        Some(runtime_fn_audio_stop_loop(module, runtime)?)
                                    }
                                    "__wr_audio_set_listener" => {
                                        Some(runtime_fn_audio_set_listener(module, runtime)?)
                                    }
                                    "__wr_audio_set_parameter" => {
                                        Some(runtime_fn_audio_set_parameter(module, runtime)?)
                                    }
                                    "__wr_physics_create_body" => {
                                        Some(runtime_fn_physics_create_body(module, runtime)?)
                                    }
                                    "__wr_physics_remove_body" => {
                                        Some(runtime_fn_physics_remove_body(module, runtime)?)
                                    }
                                    "__wr_physics_set_velocity" => {
                                        Some(runtime_fn_physics_set_velocity(module, runtime)?)
                                    }
                                    "__wr_physics_get_position_x" => {
                                        Some(runtime_fn_physics_get_position_x(module, runtime)?)
                                    }
                                    "__wr_physics_get_position_y" => {
                                        Some(runtime_fn_physics_get_position_y(module, runtime)?)
                                    }
                                    "__wr_physics_get_position_z" => {
                                        Some(runtime_fn_physics_get_position_z(module, runtime)?)
                                    }
                                    "__wr_physics_step" => {
                                        Some(runtime_fn_physics_step(module, runtime)?)
                                    }
                                    "__wr_physics_query_contacts" => {
                                        Some(runtime_fn_physics_query_contacts(module, runtime)?)
                                    }
                                    "__wr_physics_raycast" => {
                                        Some(runtime_fn_physics_raycast(module, runtime)?)
                                    }
                                    "__wr_physics_add_breakable_joint" => {
                                        Some(runtime_fn_physics_add_breakable_joint(module, runtime)?)
                                    }
                                    _ => None,
                                }
                            }
...
fn runtime_fn_game_session_create_listener(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_create_listener", sig)
}

fn runtime_fn_game_session_poll_event(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_poll_event", sig)
}

fn runtime_fn_game_session_accept_connection(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_accept_connection", sig)
}

fn runtime_fn_game_session_read_connection_bytes(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_read_connection_bytes", sig)
}

fn runtime_fn_game_session_read_http_request_frame(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_read_http_request_frame", sig)
}

fn runtime_fn_game_session_read_message(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_read_message", sig)
}

fn runtime_fn_game_session_write_connection_bytes(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_write_connection_bytes", sig)
}

fn runtime_fn_game_session_write_http_response_frame(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_write_http_response_frame", sig)
}

fn runtime_fn_game_session_write_http_response_vectored(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_game_session_write_http_response_vectored", sig)
}

fn runtime_fn_game_session_write_message(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_write_message", sig)
}

fn runtime_fn_game_session_send_file(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_game_session_send_file", sig)
}

fn runtime_fn_game_session_configure_listener_socket(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_configure_listener_socket", sig)
}

fn runtime_fn_game_session_close_connection(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_close_connection", sig)
}

fn runtime_fn_game_session_close_listener(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_game_session_close_listener", sig)
}
...
fn runtime_fn_entity_spawn(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_spawn", sig)
}

fn runtime_fn_entity_despawn(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_despawn", sig)
}

fn runtime_fn_entity_set_position(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_entity_set_position", sig)
}

fn runtime_fn_entity_get_position_x(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_get_position_x", sig)
}

fn runtime_fn_entity_get_position_y(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_get_position_y", sig)
}

fn runtime_fn_entity_get_position_z(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_get_position_z", sig)
}

fn runtime_fn_entity_set_component(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_set_component", sig)
}

fn runtime_fn_entity_get_component(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_get_component", sig)
}

fn runtime_fn_entity_query_archetype(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_entity_query_archetype", sig)
}

fn runtime_fn_entity_query_radius(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_entity_query_radius", sig)
}

fn runtime_fn_entity_count(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[], &[types::I64]);
    runtime.get_func(module, "wr_entity_count", sig)
}

fn runtime_fn_audio_play_oneshot(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_audio_play_oneshot", sig)
}

fn runtime_fn_audio_play_loop(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_audio_play_loop", sig)
}

fn runtime_fn_audio_stop_loop(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_audio_stop_loop", sig)
}

fn runtime_fn_audio_set_listener(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_audio_set_listener", sig)
}

fn runtime_fn_audio_set_parameter(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_audio_set_parameter", sig)
}

fn runtime_fn_physics_create_body(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_physics_create_body", sig)
}

fn runtime_fn_physics_remove_body(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_remove_body", sig)
}

fn runtime_fn_physics_set_velocity(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_physics_set_velocity", sig)
}

fn runtime_fn_physics_get_position_x(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_get_position_x", sig)
}

fn runtime_fn_physics_get_position_y(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_get_position_y", sig)
}

fn runtime_fn_physics_get_position_z(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_get_position_z", sig)
}

fn runtime_fn_physics_step(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_step", sig)
}

fn runtime_fn_physics_query_contacts(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(module, &[types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_query_contacts", sig)
}

fn runtime_fn_physics_raycast(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig = RuntimeRegistry::runtime_sig(
    ...
    runtime.get_func(module, "wr_physics_raycast", sig)
}

fn runtime_fn_physics_add_breakable_joint(
    module: &mut ObjectModule,
    runtime: &mut RuntimeRegistry,
) -> Result<cranelift_module::FuncId, CodegenError> {
    let sig =
        RuntimeRegistry::runtime_sig(module, &[types::I64, types::I64, types::I64], &[types::I64]);
    runtime.get_func(module, "wr_physics_add_breakable_joint", sig)
}
