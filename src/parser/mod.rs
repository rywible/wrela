...
pub enum SpiteLanguage {}

impl rowan::Language for SpiteLanguage {
...
pub type SyntaxNode = rowan::SyntaxNode<SpiteLanguage>;
pub type SyntaxToken = rowan::SyntaxToken<SpiteLanguage>;
pub type SyntaxElement = rowan::SyntaxElement<SpiteLanguage>;
pub type SyntaxNodeChildren = rowan::SyntaxNodeChildren<SpiteLanguage>;
pub type SyntaxElementChildren = rowan::SyntaxElementChildren<SpiteLanguage>;
...
mod tests {
    ...
    fn test_missing_indented_block_error() {
        ...
        assert!(errors.iter().any(|e| e.message == "expected indented block after ':'"));
    }
